...
const PodcastPlayer = styled(Player)`
...
const UnstyledContentSection = ({
  ...
  const richText = data.entry.notes.json

  return (
    <section id='article-body' className={className}>
      <Content>
        <PodcastPlayer entry={data.entry}/>
        <ContentBody id='article-content'>
          <ContentStyle/>
          <Headline>Show Notes</Headline>
